...
public class deletAllLeafNodes {
	...
	public static BinaryTree<Integer> deletLeaf(BinaryTree<Integer> root){
		if(root == null) {
			return null;
		}
		...
		BinaryTree<Integer> left = deletLeaf(root.left);
		root.left = left;
		BinaryTree<Integer> right = deletLeaf(root.right);
		root.right = right;
		return root;
	}
