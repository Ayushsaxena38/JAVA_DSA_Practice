...
public class bstClassNewBST2Problem {
	
	public class BinarySearchTree {
		private BinaryTree<Integer> root;
	    //insert data
	    //private helper for insert data
	    private BinaryTree<Integer> insertHelper(int data, BinaryTree<Integer> root){
	        if(root == null){
	    ...
	    private BinaryTree<Integer> removeHelper(int data, BinaryTree<Integer> root){
	        if(root == null){
	            return null;
	        }
	        if(data < root.data){
		...
		//tree print function
		private void printTree(BinaryTree<Integer> root) {
			if (root == null) {
				return;
			}
		...
		//search 
	    //helper function
	    private boolean helperSearch(int data, BinaryTree<Integer> root){
	        if(root == null){
	            return false;
	        }
	        if(root.data == data){
