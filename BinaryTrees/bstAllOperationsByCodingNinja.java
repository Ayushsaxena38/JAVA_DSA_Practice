...
public class bstAllOperationsByCodingNinja {
	
	public static BinaryTree<Integer> takeTreeInputBetter(boolean isRoot, int parentData, boolean isLeft){
        if(isRoot){
        ...
        BinaryTree<Integer> leftChild= takeTreeInputBetter(false, rootData, true);
        BinaryTree<Integer> rightChild= takeTreeInputBetter(false, rootData, false);
        root.left= leftChild;
    ...
    public static BinaryTree<Integer> takeTreeInput(){
        ...
        BinaryTree<Integer> root= new BinaryTree<Integer>(rootData);
        BinaryTree<Integer> leftChild= takeTreeInput();
        BinaryTree<Integer> rightChild= takeTreeInput();
        root.left= leftChild;
        root.right= rightChild;
        return root;
    ...
    public static int numLeaves(BinaryTree<Integer> root){
        if(root==null){
            return 0;
        }
...
//      }
      ...
      public static boolean searchBST(BinaryTree<Integer> root, int data){
          if(root==null){
              return false;
          }
          if(root.data==data){
      ...
      public static void printBetweenK1K2(BinaryTree<Integer> root, int k1, int k2){
          if(root==null){
              return;
          }
          if(root.data<k1){
...
//              return false;
//          }
//          int rightMin= minimum(root.right);//minimum fn is not yet written
...
//          BinaryTree<Integer> root= buildTreeFromPreIn(pre, in);
//          printTreeDetailed(root);
